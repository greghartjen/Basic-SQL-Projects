...
BEGIN
	...
	INSERT INTO tbl_persons
		...
		VALUES
		('bob', 'smith', '233-345-5768'),
		('greg', 'hart', '233-256-4568'),
		('sandy', 'dee', '233-231-1980'),
		('jen', 'doe', '233-231-5768'),
		('mike', 'tony', '233-321-8882')
	;
	...
	INSERT INTO tbl_specialist
		...
		VALUES
		('margaret', 'nyguen', '456-523-2354'),
		('mary', 'fischer', '456-987-9087'),
		('arnold', 'holden', '456-765-6987'),
		('ken', 'byesan', '456-453-2431'),
		('delmonte', 'fyedo', '456-784-2365')
	;
	...
	CREATE TABLE tbl_species (
		...
		species_animal INT NOT NULL CONSTRAINT fk_animal_id FOREIGN KEY REFERENCES tbl_animal(animal_id) ON UPDATE CASCADE ON DELETE CASCADE,
	...
	INSERT INTO tbl_species
		(species_name, species_animal, species_class, species_order, species_habitat, species_nutrition, species_care)
		VALUES
	...
	SELECT
		...
		FROM tbl_species a1
		INNER JOIN tbl_animal a2 ON a2.animal_id = a1.species_animal
